...
$YJ_modules = array();
$YJ_max_modules = 3;
$YJ_module_prefix = 'bodytop';
$YJ_starting_key = 1;
$grid_widths = explode('|', $this->params->get( 'yjsg_bodytop_width' ));
require( TEMPLATEPATH.DS."yjsgcore/yjsg_widths.php");
?>
<?php if( $YJ_modules ):?>
<div id="yjsgbodytop" style="font-size:<?php echo $css_font; ?>;">
	...
	<div id="<?php echo $mod_name;?>" class="yjsgxhtml" style="width:<?php echo $mod_width;?>%;">
		<jdoc:include type="modules" name="<?php echo $mod_name;?>" style="<?php echo $YJsgmt_module_style ?>" />
	</div>
	<?php endforeach;?>
</div>
<?php endif;?>