...
$YJ_modules = array();
$YJ_max_modules = 5;
$YJ_module_prefix = 'adv';
$YJ_starting_key = 1;
$grid_widths = explode('|', $this->params->get( 'yjsg_2_width' ));
...
<div id="yjsg2">
	...
	<div id="<?php echo $mod_name;?>" class="yjsgxhtml" style="width:<?php echo $mod_width;?>%;">
		<jdoc:include type="modules" name="<?php echo $mod_name;?>" style="<?php echo $YJsg2_module_style ?>" />
	</div>
	<?php endforeach;?>
</div>
<?php endif;?>