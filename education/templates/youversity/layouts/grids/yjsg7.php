...
$YJ_starting_key = 21;
$grid_widths = explode('|', $this->params->get( 'yjsg_7_width' ));
require( TEMPLATEPATH.DS."yjsgcore/yjsg_widths.php");
?>
<?php if( $YJ_modules ):?>
<div id="yjsg7" style="font-size:<?php echo $css_font; ?>; width:<?php echo $css_width.$css_widthdefined; ?>;">
	...
	<div id="<?php echo $mod_name;?>" class="yjsgxhtml" style="width:<?php echo $mod_width;?>%;">
		<jdoc:include type="modules" name="<?php echo $mod_name;?>" style="<?php echo $YJsg7_module_style ?>" />
	</div>
	<?php endforeach;?>
</div>
<?php endif;?>