...
class Auth extends CRM_Controller {
	...
	function login()
	{
		...
		{  //the user is not logging in so display the login page
			...
			$vData = array();
			echo $this->load->view('auth/login', $this->data, TRUE);
		}
	}
	...
	function edit()
	{
		...
		{ //display the form
			...
			$vData = array();
			$vData['title'] = 'Edit Profile';
			$vData['pagetype'] = 'settings';
			$vData['content'] = $this->load->view('auth/edit', $this->data, TRUE);
	...
	function activate($id, $code=false)
	{
		...
		if ($activation)
		{
			...
			$this->session->set_flashdata('message', $this->ion_auth->messages());
			redirect("settings/user_list", 'refresh');
		}
		else
		{
