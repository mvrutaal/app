...
<div id="crmwrapper">
	...
	<div id="crmtop" class="clearix">
		...
		<ul id="menu">
			...
			<?php if ($this->acl->can_read($this->session->userdata['group'], 'hrm')):?>
				<li <?php if ($pagetype == 'hrm'):?>class="active dropdown"<?php endif;?> class="dropdown">
					<a href="<?=site_url('hrm')?>" class="hrm dropdown-toggle" data-toggle="dropdown" href="#menu1">HRM</a>
					<ul class="dropdown-menu">
                        <?php if ($this->acl->can_write($this->session->userdata['group'], 'hrm')){  ?>
                        <li><a href="<?=site_url('hrm/allocate')?>">Allocate Holiday</a></li>
                        <li class="divider"></li>
                        <li><a href="<?=site_url('hrm/add')?>">Add Employee Holiday</a></li>
						<li class="divider"></li>
                        <?php } ?>
						<li><a href="<?=site_url('hrm/index')?>">View</a></li>
						<!-- <li><a href="<?=site_url('hrm/accounts')?>">Budget Accounts</a></li>
						<li class="divider"></li>
						<li><a href="<?=site_url('hrm/reports')?>">Reports</a></li> -->
					</ul>
				</li>
			<?php endif;?>
