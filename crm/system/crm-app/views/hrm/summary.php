<script type="text/javascript" src="<?=base_url()?>assets/js/modules/summary.js"></script>
...
<div id="contentwrapper">
	...
	<div id="content">
		...
		<table id="summaryDT" class="datatable CrmTable" cellspacing="0" cellpadding="0" border="0" width="100%" data-url="hrm/ajax_leavedatatable/<?php echo $contact_id; ?>" data-name="leaveDetails" data-checkable="yes">
			<thead>
				<tr>
