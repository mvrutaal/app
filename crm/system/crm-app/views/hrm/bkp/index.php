...
<div id="contentwrapper">
	<div id="title_block">
		...
		<a href="<?=site_url('hrm/add')?>" class="linkbtn add"><span>New Entry</span></a>
		<?php endif;?>
	...
	<div id="content">
		...
		<table id="HrmDT" class="datatable CrmTable" cellspacing="0" cellpadding="0" border="0" width="100%" data-url="hrm/ajax_datatable/" data-name="holidayData" data-checkable="yes">
			<thead>
				<tr>
...
CRM.DatatablesCols['holidayData'] = [];
CRM.DatatablesCols['holidayData'].push({mDataProp:'contact_id', bSortable: false, sWidth:'38px'});

<?php foreach ($standard_cols as $col_name => $col):?>
CRM.DatatablesCols['holidayData'].push({mDataProp:'<?=$col_name?>', bSortable: <?=$col['sortable']?>});
<?php endforeach;?>
