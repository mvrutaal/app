...
*/
	 ...
	 * Tables.
	 **/
	$config['tables']['groups']  = 'crm_auth_roles';
	$config['tables']['users']   = 'crm_auth_users';
	$config['tables']['meta']    = 'crm_contacts';

	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "Forma CRM";

	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "victor@deviarte.com";
