...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $additional_data, $group_name = false, $activate = false) //need to test email activation
	{
		$email_activation = !$activate ? $this->ci->config->item('email_activation', 'ion_auth') : $activate;
